...
def create_list(n,num):
    ...
    return numbers
print(create_list(20, 1))
print(create_list(10, 4))
...
# func(12, 4, "yeeeeey", 3, 4, [2, 3, 4])

def any_arg(*args):
    """ Функция которая принимает любое количество арнументов и выводит их га экран"""
    print('args=', args)
    for arg in args:
        print(arg)

any_arg(2, 3, 4, "goooooooooooo", "yesssssssssss", {1, 1}, [], {3, 4 ,5})
any_arg()
